	...
	load: function(){
		...
		this.nodes.forEach(function(e, i){
			...
			e.onerror = function(){
				...
				if(!~errArr.indexOf(this.src)){
						errArr.push(this.src);
						var _this = this;
						setTimeout(function(){
							_this.src = e.getAttribute('data-src');
						}, 2000)
				}
			}
		});
...
var cwarn = (function(){if(window.console && window.location.host === "localhost") return function cwarn(val){console.warn(val);};else return function cwarn(){};})();
